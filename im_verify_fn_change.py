...
if __name__ == '__main__':
    ...
    for ki in range(11):
        ...
        for i in range(99):
                    ...
                    # 压缩1~4次后与原图比较
                    for j in range(3):
                        HASH_orgin = pHash_verify("WB2019/Database_y1/" + str(i+1) + ".jpg", k)
                        HASH_after = pHash_verify("WB2019/Database_y" + str(j+2) + "/" + str(i+1) + ".jpg", k)
                        ...
                        if (n < 0.95):
                            if k == 8:
                                print("WB2019/Database/" + str(i+1) + "_450.png" + " 与 " +
                                        ...
                                        "相似:", n)
                            count += 1
        print("误识别为不同图片的张数：" + str(count) + "/298 (99*3)")
