# 验证与其他图像的相似度变化——发现由于数据集太小，8*8之前就没有相似的图像了（FP测试）（8*8,12*12均为0）。
import cv2
import numpy as np
import time
            ...
            for d in range(99):
                ...
                if i == d:
                    ...
                    for j in range(1):
                        ...
                        HASH_after = pHash_verify("WB2019/Database_y" + str(j+1) + "/" + str(d+1) + ".jpg", k)
                        ...
                        if (n >= 0.95):
                            ...
                            #             "WB2019/Database_y" + str(j+1) + "/" + str(d+1) + ".jpg" +
                            #             "相似:", n)
                            count += 1
        print(str(count) + "/9702 (99*98*1)")
